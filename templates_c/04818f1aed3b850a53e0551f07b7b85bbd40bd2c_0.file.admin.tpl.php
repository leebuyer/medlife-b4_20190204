<?php
/* Smarty version 3.1.33, created on 2019-02-04 14:39:07
  from 'D:\UniServerZ\www\medlife-b4_20190204\templates\admin.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5c584e8b5ce481_22741022',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '04818f1aed3b850a53e0551f07b7b85bbd40bd2c' => 
    array (
      0 => 'D:\\UniServerZ\\www\\medlife-b4_20190204\\templates\\admin.tpl',
      1 => 1549291141,
      2 => 'file',
    ),
  ),
...
function content_5c584e8b5ce481_22741022 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
                        ...
                        <h5 class="mb-50">Get in touch</h5>
                         ...
                         <form action="admin.php" method="post">
                            <div class="form-group">
                                <label for="title" class="col-form-label sr-only">問卷標題</label>
                                <input type="text" class="form-control" name="title" id="title" placeholder="請輸入問卷標題">
                            </div>
                            <div class="form-group">
                                <label for="content" class="col-form-label sr-only">問卷內容</label>
                                <textarea name="content" id="content" rows="20" class="form-control" placeholder="請輸入問卷內容"></textarea>
                            </div>
...
<p>Re-distributed by <a href="https://themewagon.com/" target="_blank">Themewagon</a>
    ...
    <?php echo '<script'; ?>
 src="js/jquery/jquery-2.2.4.min.js"><?php echo '</script'; ?>
>
    <!-- Popper js -->
    <?php echo '<script'; ?>
...
>
    <!-- Active js -->
    <?php echo '<script'; ?>
 src="js/active.js"><?php echo '</script'; ?>
>
    <!-- Google Maps -->
    <?php echo '<script'; ?>
...
>
    <?php echo '<script'; ?>
 src="js/map-active.js"><?php echo '</script'; ?>
>
